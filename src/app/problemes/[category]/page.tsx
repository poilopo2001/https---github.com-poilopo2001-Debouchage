...
import { getProblemCategoryBySlug, problemCategories } from '@/data/problems'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const category = getProblemCategoryBySlug(params.category)
  ...
  return {
    title: category.seo?.title || `${category.name} | Solutions Professionnelles`,
...
export default function ProblemCategoryPage({ params }: Props) {
  const category = getProblemCategoryBySlug(params.category)
                ...
                <div className="mt-16 bg-blue-50 rounded-2xl p-8 md:p-12">
                  <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 mb-8">
                      Notre équipe de professionnels est disponible 24/7 pour intervenir rapidement sur tous vos problèmes de {category.name.toLowerCase()}
                    </p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
                <div className="max-w-2xl mx-auto">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a 
                      href="/problemes"
                      className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-blue-600 bg-white border-2 border-blue-600 rounded-full hover:bg-blue-50 transition-colors duration-300"
                    >
